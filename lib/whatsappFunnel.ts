...
export const WHATSAPP_MESSAGES: Record<WhatsAppMessageKey, string> = {
  ...
  gym:
    "Hi Sanjay — Gym Website Package enquiry.\n\nGym/studio name: \nCity: \nPlans to show: \nTrial offer: ",
  coaching:
...
export const INSTANT_INQUIRY_OPTIONS: {
  ...
  { id: "consultation", label: "Free 15-min consultation", shortLabel: "Free consult", description: "Scope, stack & written estimate" },
  { id: "fastPackage", label: "Fast-launch package", shortLabel: "Fast package", description: "5-day site, 48h landing, industry packs" },
  { id: "audit", label: "Free website audit", shortLabel: "Free audit", description: "Speed, mobile UX & lead checklist" },
  { id: "pricing", label: "Written price estimate", shortLabel: "Get quote", description: "Package or custom scope" },
];

export const INSTANT_INQUIRY_FLOW = {
  title: "Instant WhatsApp inquiry",
  subtitle: "Tap → WhatsApp opens with a pre-filled message. Add your business name and send — Sanjay replies personally.",
  steps: [
...
export const QUALIFICATION_QUESTIONS = [
  ...
  { id: "goal", question: "Main goal", example: "New site / redesign / landing page / MVP / AI chat" },
  ...
  { id: "content", question: "Content ready?", example: "Logo, photos, copy — yes / partial / need help" },
] as const;
...
export const TRUST_WHATSAPP_COPY = {
  ...
  founderLine: "“Main personally padhta hoon — scope clear likh ke bhejta hoon, phir hi payment.” — Sanjay, Bitcraftly",
} as const;
...
export const QUICK_REPLY_TEMPLATES = {
  ...
  followUp24h: "Hi — kal ki enquiry par follow-up. Koi sawal ho scope/price par to bata dena, warna main slot hold kar dunga?",
} as const;
...
export function resolveWhatsAppMessage(params: WhatsAppInquiryParams): string {
  ...
  if (service) {
    ...
    if (s.includes("5 day") || s.includes("business website in 5")) return WHATSAPP_MESSAGES.business5day;
