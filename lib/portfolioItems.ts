...
export const homePortfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    featureBullets: ["Milk subscription UX", "Razorpay auto-pay", "Farm-to-home storytelling", "Bihar delivery trust"],
    ...
    caseStudy: defaultCaseStudy({
      ...
      performance: [
        { label: "Subscription", value: "Flexible", note: "Daily · weekly · custom — pause anytime" },
      ...
      trustNote: "Production client site at kunwardairy.com — same subscription & ecommerce standards we offer D2C food brands.",
    }),
  },
  {
    title: "Gym Website",
