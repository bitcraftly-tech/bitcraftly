...
*This document is the definitive environment variable inventory for `release/v1.0-launch`. Re-run this audit when adding integrations (Sentry, analytics, payment providers) or new server actions that require secrets.*
