...
const NAV_COLS = [
  {
    ...
    links: [
      ...
      { label: "Certificate Verification", href: "https://rpytech.in/index.php/certificate-verification" },
      { label: "Marksheet Verification",   href: "https://rpytech.in/index.php/marksheet-verification" },
    ],
  },
  {
    title: "Quick Access",
        ...
        <div className="rpyv2-container">
          <div className="rpyv2-footer-main">
            ...
            <div className="rpyv2-footer-brand-col">
              <div className="rpyv2-footer-brand-row">
                <div className="rpyv2-footer-logo-mark" aria-hidden>RPY</div>
                <div className="rpyv2-footer-brand-name">
                  RPY<span>Tech</span>
                </div>
              </div>
              <p className="rpyv2-footer-tagline">
                Permanent Proud Yellow Educational &amp; Welfare Trust. Empowering skills,
          ...
          <div className="rpyv2-footer-contact-strip">
            ...
            <div className="rpyv2-footer-contact-pill">
              ...
              <span>Shyama Market, 1st Floor, Near Ghosh &amp; Sinha Petrol Pump, Mirganj, Gopalganj, Bihar 841438</span>
            </div>
          </div>
