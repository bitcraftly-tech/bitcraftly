      ...
      <div className="rpyv2-container">
        ...
        <div className="rpyv2-courses-hd">
          <div>
            ...
            <p className="rpyv2-courses-sub">Industry-recognised certifications designed to fast-track your career.</p>
          </div>
          <a
        ...
        <div className="rpyv2-courses-grid">
          {COURSES.map(({ name, desc, duration, level, accent, icon }) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="rpyv2-crs-icon" aria-hidden>{icon}</div>
