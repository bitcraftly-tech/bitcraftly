...
export const RPYTECH_SOCIAL_ICONS = [FacebookIcon, XIcon, InstagramIcon, LinkedInIcon, YoutubeIcon] as const;
export const RPYTECH_FOOTER_SOCIAL_ICONS = [FacebookIcon, XIcon, InstagramIcon, YoutubeIcon, LinkedInIcon] as const;
