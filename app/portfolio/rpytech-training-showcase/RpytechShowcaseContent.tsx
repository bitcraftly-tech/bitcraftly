...
export default function RpytechShowcaseContent() {
  return (
    <div className={poppins.className}>
        ...
        <div className={RPYTECH_CONTAINER}>
          ...
          <div className="rpytech-courses-grid">
            {RPYTECH_COURSES.map((course) => (
              <article key={course.title} className={`rpytech-course-card rpytech-course-card--${course.tone}`}>
      ...
      <section id="placement" className="rpytech-placement-section rpytech-page-section scroll-mt-28">
        <div className={`${RPYTECH_CONTAINER} rpytech-placement-inner`}>
          <div className="rpytech-placement-left">
            ...
            <p>We provide 100% placement assistance to our students. Get placed in top companies across India and abroad.</p>
          ...
          <div className="rpytech-placement-cards">
            {RPYTECH_PLACEMENTS.map((s) => (
              <div key={s.name} className="rpytech-place-card">
                <div className={`rpytech-company-logo rpytech-company-logo--${s.companyTone}`}>{s.company}</div>
      ...
      <section id="franchise" className="rpytech-franchise-section rpytech-page-section scroll-mt-28">
        <div className={`${RPYTECH_CONTAINER} rpytech-franchise-inner`}>
          <div className="rpytech-franchise-left">
            ...
            <p>Join RPYTech as a franchise center and grow with India&apos;s most trusted training brand.</p>
            <button type="button" className="rpytech-btn-primary rpytech-btn-sm">
              ENQUIRE NOW →
            </button>
          </div>
