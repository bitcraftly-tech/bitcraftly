    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="block">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Your name</span>
          <input
            required
            type="text"
            value={name}
        ...
        <label className="block">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Phone / WhatsApp</span>
          <input
            required
            type="tel"
            value={phone}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="block">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Service</span>
          <select
            value={service}
        ...
        <label className="block">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Locality / pincode</span>
          <input
            type="text"
            value={area}
      ...
      <label className="block">
        <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Job details</span>
        <textarea
          rows={3}
          value={notes}
      ...
      <p className="text-[10px] text-dark-text-tertiary">Showcase — forwards to Bitcraftly contact with your enquiry context.</p>
    </form>
  );
}
