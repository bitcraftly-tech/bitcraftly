...
export default function SchoolQuickActions() {
  const { showToast, scrollToEnquiry, scrollToSection, setModalType, handleUsefulLink } = useSchoolDemo();
          ...
          {QUICK_ACTIONS.map((a) => {
            ...
            return (
              ...
              >
                ...
                <p className="school-text-muted mt-1 text-[10px] leading-tight sm:text-xs">{a.desc}</p>
              </button>
            );
          })}
        </div>
