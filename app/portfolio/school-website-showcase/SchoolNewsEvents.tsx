  ...
  return (
    <section id="news-events" className={`${CONTAINER} scroll-mt-28 py-16`}>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h2 className="mt-2 text-3xl font-bold tracking-tight text-[var(--school-navy)] sm:text-4xl">News & Events</h2>
      </div>
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-2">
        <div>
          <div className="mb-5 flex items-center justify-between">
            ...
            <button type="button" onClick={() => showToast("All news · demo")} className="inline-flex items-center gap-1 text-xs font-semibold text-[var(--school-orange)] hover:underline">
              ...
              <li key={n.id}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-[var(--school-orange)]">{n.date}</p>
                    <p className="mt-1 text-base font-bold leading-snug text-[var(--school-navy)]">{n.title}</p>
        ...
        <div>
          <div className="mb-5 flex items-center justify-between">
            ...
            <button type="button" onClick={() => showToast("Event calendar · demo")} className="inline-flex items-center gap-1 text-xs font-semibold text-[var(--school-orange)] hover:underline">
