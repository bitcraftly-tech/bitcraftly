...
export function SchoolAdmissionForm({ compact = false, dense = false, hero = false, onSuccess }: SchoolAdmissionFormProps) {
    ...
    return (
      <form onSubmit={submit} className="space-y-2.5">
        ...
        <input
          ...
          className={fieldClass}
        />
        <select value={academicYear} onChange={(e) => setAcademicYear(e.target.value)} className={fieldClass}>
        ...
        <select required value={grade} onChange={(e) => setGrade(e.target.value)} className={fieldClass}>
        ...
        />
        <button type="submit" className="school-btn-orange w-full rounded-md py-3 text-sm font-bold uppercase tracking-wide">
          Submit Enquiry
        </button>
        <button
          type="button"
