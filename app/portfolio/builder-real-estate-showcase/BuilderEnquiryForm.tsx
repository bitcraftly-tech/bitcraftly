  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Email</span>
          <input
            type="email"
            required
            value={email}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Interested in</span>
          <select
            value={interest}
      ...
      <label className="block">
        <span className="text-[11px] font-semibold uppercase tracking-wide text-dark-text-tertiary">Message</span>
        <textarea
          rows={3}
          value={message}
      ...
      <p className="text-[10px] text-dark-text-tertiary">
        Showcase form — submits to Bitcraftly contact with your details prefilled in the query string where supported.
      </p>
    </form>
  );
}
