...
const TILES: Record<(typeof FILTERS)[number], { label: string; tone: string }[]> = {
  All: [
    ...
    { label: "Grand lobby · arrival court", tone: "from-neutral-800 via-amber-950/50 to-slate-100" },
    { label: "Landscape podium · gardens", tone: "from-emerald-900/30 via-slate-900 to-slate-100" },
    { label: "Penthouse terrace · city grid", tone: "from-fuchsia-900/40 via-violet-100 to-slate-100" },
  ],
  Towers: [
