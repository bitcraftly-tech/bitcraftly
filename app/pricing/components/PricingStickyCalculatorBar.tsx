    ...
    <div data-skip-scroll-reveal>
      ...
      >
        <div className={`${CONTAINER} py-2 pb-[max(0.5rem,env(safe-area-inset-bottom,0px))]`}>
          <button
            type="button"
            onClick={() => scrollToElementWithRetry("project-cost-calculator")}
            className="flex min-h-[48px] w-full items-center justify-center gap-2.5 rounded-xl px-3 transition active:scale-[0.99] sm:gap-3"
          >
