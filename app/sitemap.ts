...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = [
    ...
    { path: "/website-development-company-ghaziabad", priority: 0.88, changeFrequency: "monthly" as const },
    { path: "/website-development-company-noida", priority: 0.88, changeFrequency: "monthly" as const },
