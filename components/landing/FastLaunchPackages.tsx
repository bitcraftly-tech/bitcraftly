...
import { FAST_PACKAGES, FAST_PACKAGES_SECTION } from "@/lib/fastPackages";
        ...
        {FAST_PACKAGES.map((pkg) => (
          ...
          >
            ...
            <div className="mt-auto pt-6">
              <Link
                href={`/contact?service=${encodeURIComponent(pkg.contactSlug)}&intent=quote&source=fast-package`}
