    ...
    <div className={`flex flex-wrap items-center gap-2 ${className}`} role="group" aria-label="Follow Bitcraftly">
      {links.map((item) => (
        <a
          ...
          className={`inline-flex h-9 w-9 items-center justify-center rounded-full border border-border-secondary text-text-secondary transition hover:border-indigo-500/40 hover:bg-indigo-50 hover:text-indigo-600 dark:border-dark-border-secondary dark:text-dark-text-secondary dark:hover:border-indigo-500/40 dark:hover:bg-indigo-950/40 dark:hover:text-indigo-400 ${iconClassName}`}
        >
