  ...
  return (
    <footer className="border-t border-border-primary bg-bg-card dark:border-dark-border-primary dark:bg-dark-bg-card">
      <div className={`${CONTAINER} py-8 md:py-10`}>
        ...
        <div className="bc-footer-bottom mt-10 flex flex-col items-center gap-3 border-t border-border-primary pt-6 text-center max-md:pb-[var(--bc-mobile-sticky-h,5.5rem)] md:pb-0 dark:border-dark-border-primary">
