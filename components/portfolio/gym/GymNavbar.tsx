    ...
    <header className="gym-bg-card sticky top-0 z-50 border-b gym-border">
      <div className={`${CONTAINER} flex items-center justify-between gap-4 py-3`}>
        ...
        <div className="hidden items-center gap-3 sm:flex">
          ...
          <button type="button" onClick={() => setTrialOpen(true)} className="gym-btn-primary rounded-full px-5 py-2 text-sm">
            Get free trial
          </button>
        </div>
      ...
      {menuOpen ? (
        <div className="gym-border border-t px-4 py-4 md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <button type="button" onClick={() => setTrialOpen(true)} className="gym-btn-primary rounded-full py-2.5 text-sm">
              Get free trial
            </button>
          </div>
        </div>
