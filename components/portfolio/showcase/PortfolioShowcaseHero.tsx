    ...
    >
      ...
      <div className="ps-showcase-hero-aside">
        <div className="ps-showcase-stats-panel">
          ...
          <aside className="ps-showcase-stats w-full max-w-full min-w-0" aria-label="Portfolio highlights">
            {SHOWCASE_STATS.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.38, delay: 0.08 + index * 0.07, ease: [0.22, 1, 0.36, 1] }}
        ...
        {isHome ? (
          <Link href="/portfolio" className="ps-showcase-link ps-showcase-link--cta" {...newTabProps("/portfolio")}>
