...
function PreviewImage({
  ...
  return (
    <div className={`absolute inset-0 origin-center transition-transform duration-250 ease-out ${hoverScaleClass}`}>
      <Image
...
export default function PortfolioCardThumbnail({ project, variant = "card" }: PortfolioCardThumbnailProps) {
  ...
  if (featured) {
    return (
    <div ref={ref} className="ps-browser-frame overflow-hidden rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] dark:border-dark-border-primary dark:bg-dark-bg-secondary">
      {!hasImage ? (
  ...
  return (
    <div ref={ref} className="ps-browser-frame overflow-hidden rounded-lg border border-[#E5E7EB] bg-[#F9FAFB] dark:border-dark-border-primary dark:bg-dark-bg-secondary">
      {!hasImage ? (
