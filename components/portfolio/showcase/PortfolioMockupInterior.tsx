    ...
    case "chatbot":
      return (
        <div className="flex h-full flex-col justify-end gap-1 p-2">
          <span className="ml-0 mr-auto max-w-[75%] rounded-lg rounded-bl-sm border border-[#E5E7EB] bg-[#F9FAFB] px-1.5 py-1 text-[7px]">Hi there</span>
          <span className="ml-auto max-w-[75%] rounded-lg rounded-br-sm bg-[#374151] px-1.5 py-1 text-[7px] text-white">How can I help?</span>
        </div>
      );
    case "clinic":
      return (
        <div className="grid h-full grid-cols-2 gap-1.5 p-2">
          {[1, 2].map((i) => (
            <div key={i} className="flex flex-col items-center rounded border border-[#E5E7EB] bg-[#FAFAFA] p-1">
