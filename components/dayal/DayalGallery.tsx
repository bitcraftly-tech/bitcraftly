...
const GALLERY = [
  { src: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&q=80", alt: "Luxury villa exterior", span: "lg:col-span-2 lg:row-span-2" },
  { src: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80", alt: "Modern living room", span: "" },
  { src: "https://images.unsplash.com/photo-1600566753190-17f0baa5a6c3?w=600&q=80", alt: "Township landscape", span: "" },
  { src: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=600&q=80", alt: "Pool and amenities", span: "" },
  { src: "https://images.unsplash.com/photo-1600047509807-ba8f86d690ca?w=900&q=80", alt: "Aerial drone view", span: "lg:col-span-2" },
] as const;
    ...
    <section id="gallery" className="bg-white py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <DayalReveal className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#c8a46b]">Gallery</p>
