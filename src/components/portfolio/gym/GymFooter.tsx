  ...
  return (
    <footer className="gym-bg-surface border-t gym-border">
      ...
      <div className="gym-border border-t py-6">
        <div
          className={`${CONTAINER} flex flex-col items-center justify-between gap-3 text-center text-xs text-[var(--gym-muted)] sm:flex-row sm:text-left`}
        >
          ...
          <p>
            ...
            <Link
              ...
              className="gym-brand-text hover:underline"
