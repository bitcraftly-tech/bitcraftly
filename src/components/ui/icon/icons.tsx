...
export const iconRegistry: Record<IconName, IconDefinition> = {
  ...
  star: {
    paths: ['M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22 12 18.56 5.82 22 7 14.14l-5-4.87 6.91-1.01z'],
  },
  menu: {
  ...
  linkedin: {
    paths: ['M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6z', 'M2 9h4v12H2z'],
