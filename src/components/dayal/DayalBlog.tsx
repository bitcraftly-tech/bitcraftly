...
export default function DayalBlog() {
  return (
    <section
      id="blog"
      className="scroll-mt-20 border-t border-[#0b1633]/6 bg-white py-12 sm:scroll-mt-24"
    >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
            <div className="min-w-0">
              ...
              <p className="dayal-body mt-3 max-w-2xl">
                Get the latest updates on quality construction, innovation, and new projects from
                Dayal Builders.
              </p>
            </div>
            <a
