...
export const CS_SAASPRO: CaseStudy = {
  ...
  techStack: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'PostgreSQL', 'Stripe'],
  architecture: [
    {
      id: 'edge',
      title: 'App Router edge',
      description: 'Thin route files compose feature modules with metadata and JSON-LD.',
    },
    {
      id: 'domain',
      title: 'Domain modules',
      description: 'Billing, analytics, and workspace settings isolated behind typed services.',
    },
    {
      id: 'data',
