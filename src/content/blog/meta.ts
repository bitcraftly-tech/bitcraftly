...
export const BLOG_CATEGORIES: readonly BlogCategory[] = [
  ...
  },
  {
    id: 'react',
    label: 'React',
    description: 'Modern React 19 patterns, component design, and maintainable UI architecture.',
  },
  {
    id: 'web-performance',
    label: 'Web Performance',
    description: 'Core Web Vitals, image strategy, and rendering decisions that keep sites fast.',
  },
  {
    id: 'seo',
    label: 'SEO',
