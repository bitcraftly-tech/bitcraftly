...
export const ALL_WORK_LINKS: readonly NavLinkItem[] = WORK_GROUPS.flatMap((group) => [
  ...group.items,
]);
...
export const WORK_FEATURED: NavFeaturedCard = {
  ...
  badge: 'Showcase',
  highlights: ['Websites & web apps', 'AI solutions', 'SaaS platforms', 'Enterprise software'],
};
...
export const SERVICE_RELATED_WORK: Record<string, readonly string[]> = {
  ...
  'web-application-development': [`${WORK_BASE}/web-applications`, `${WORK_BASE}/portfolio`],
  ...
  'custom-software-development': [`${WORK_BASE}/enterprise`, `${WORK_BASE}/web-applications`],
...
export function getRelatedServicesForWork(workSlug: string): readonly string[] {
