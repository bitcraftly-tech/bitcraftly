  ...
  return (
    ...
    >
      <header className="ai-assistant__message-meta">
        <span className="ai-assistant__message-role">{isUser ? 'You' : 'Bitcraftly AI'}</span>
        {isStreaming ? <span className="ai-assistant__message-streaming">Streaming</span> : null}
      </header>
      <div className="ai-assistant__message-body ai-md">
        ...
        {isStreaming ? <span className="ai-assistant__caret" aria-hidden="true" /> : null}
      </div>
    </article>
  );
}
