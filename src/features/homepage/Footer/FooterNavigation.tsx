...
import { FOOTER_COMPANY_COLUMN, FOOTER_LINK_COLUMNS, FOOTER_NAV_COLUMNS } from './footer.constants';
...
export function FooterCompanyColumn({ className }: { className?: string }) {
  return <FooterNavGroup column={FOOTER_COMPANY_COLUMN} className={className} />;
}
