...
export const PROCESS_STEPS: readonly ProcessStep[] = [
  ...
  },
  {
    ...
    description:
      "Pages, features, timeline, and written estimate in plain language.",
    icon: "rocket",
  },
  {
    id: "development",
    ...
    description:
      "React or Next.js build — mobile-first, SEO-structured, on-brand.",
    icon: "code",
  },
  {
    id: "review",
  ...
  },
  {
    ...
    description:
      "Forms, devices, speed, and SEO basics checked before go-live.",
    icon: "zap",
  },
  {
    id: "launch",
    ...
    description:
      "Go live with handoff, training, and optional monthly care.",
    icon: "headset",
  },
] as const;
...
export const PROCESS_SIDE_CTA: ProcessCtaContent = {
  ...
  description:
    "Book a short call — scope, timeline, and a written estimate in plain language.",
