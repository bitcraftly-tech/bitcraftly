...
export function WhyBitcraftlyCardView({ card, className }: WhyBitcraftlyCardViewProps) {
  return (
    <article className={cn('why-card flex h-full flex-col rounded-[16px] card-padding', className)}>
      <div className="why-card-header flex flex-row items-center gap-[12px]">
        <span className="why-card-icon inline-flex shrink-0">
          <IconBox icon={card.icon} variant="default" size="sm" className="why-icon-box" />
        </span>
