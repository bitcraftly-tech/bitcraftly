...
export const HOMEPAGE_SERVICES: readonly HomepageService[] = [
  ...
  },
  {
    ...
    description:
      "SaaS platforms, dashboards, and custom web apps engineered for speed and scale.",
  ...
  },
  {
    ...
    title: "Mobile Apps",
    description:
      "Native and cross-platform apps for Android and iOS with polished product UX.",
  ...
  },
  {
    ...
    description:
      "ERP, CRM, CMS, and bespoke tools tailored to your teams and operations.",
