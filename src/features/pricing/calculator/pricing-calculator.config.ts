...
export const FEATURE_OPTIONS: readonly (PricingOption<FeatureId> & {
  ...
  {
    id: 'cms',
    label: 'CMS / editable pages',
    description: 'Content updates without deploys',
    price: 12000,
  },
  ...
  },
  {
    ...
    description: 'Editorial listing and detail pages',
    price: 9000,
  },
  { id: 'admin', label: 'Admin panel', description: 'Internal operators console', price: 28000 },
  {
    id: 'seo',
    label: 'Technical SEO pack',
    description: 'Metadata, schema, sitemap hygiene',
    price: 8000,
  },
  {
    id: 'analytics',
    label: 'Analytics setup',
    description: 'Events and conversion tracking',
    price: 6000,
  },
  {
    id: 'ai-chat',
    label: 'AI assistant',
    description: 'Guided chat or concierge experience',
    price: 35000,
  },
  {
    id: 'multilingual',
    label: 'Multilingual',
    description: 'Locale routing and content structure',
    price: 15000,
  },
  {
    id: 'api',
    label: 'Custom API integrations',
    description: 'Third-party systems and webhooks',
    price: 20000,
  },
] as const;
...
export const PACKAGE_BANDS = [
  {
    max: 30000,
    name: 'Starter Launch',
    summary: 'Focused site with core CTAs and clean SEO foundations.',
  },
  {
    max: 75000,
    name: 'Growth Website',
    summary: 'Broader content, conversion UX, and selective feature add-ons.',
  },
  {
    max: 150000,
    name: 'Business Platform',
    summary: 'Richer workflows, integrations, and operator-ready surfaces.',
  },
  {
    max: Number.POSITIVE_INFINITY,
    name: 'Custom Product Build',
    summary: 'Scoped product engineering with phased delivery.',
  },
] as const;
