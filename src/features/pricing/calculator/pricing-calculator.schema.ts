...
export const websiteTypeValues = [
  "marketing",
  "business",
  "ecommerce",
  "web-app",
...
export type PricingCalculatorFormValues = z.infer<
  typeof pricingCalculatorSchema
>;
