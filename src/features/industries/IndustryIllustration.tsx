 ...
 */
export function IndustryIllustration({ illustration, className }: IndustryIllustrationProps) {
  return (
    <div className={cn('industries-card__illust', className)} aria-hidden>
      <Icon name={ILLUSTRATION_ICON[illustration]} size="md" className="h-[20px] w-[20px]" />
    </div>
  );
}
