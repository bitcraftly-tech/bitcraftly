...
export const INDUSTRIES_CATALOG: readonly IndustryModel[] = [
  {
    ...
    shortLabel: "Care",
    description:
      "Patient portals, clinic ops, and compliance-aware platforms for care teams that cannot afford downtime.",
    icon: "shield",
    illustration: "care",
    accent: "teal",
    featured: true,
  ...
  },
  {
    ...
    shortLabel: "Property",
    description:
      "Listings, broker tools, and owner portals that make property discovery and deals measurable.",
    icon: "globe",
...
export const INDUSTRIES_LANDING = {
  ...
  solutionsDescription:
    "Composable builds that plug into how your industry already works.",
  techHeading: "Technology stack",
  techDescription:
    "Modern web, APIs, cloud, and AI — chosen for maintainability in your domain.",
  casesHeading: "Outcomes by industry",
  casesDescription:
    "Representative results from vertical engagements — scoped, shipped, measured.",
  ...
  processDescription:
    "A grounded path from domain discovery to systems your team can own.",
  ...
  whyDescription:
    "Vertical empathy plus production engineering — without agency theater.",
