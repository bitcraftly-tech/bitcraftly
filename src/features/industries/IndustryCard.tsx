...
const PRIORITY_FEATURED = new Set(['healthcare', 'fintech', 'retail-ecommerce']);
...
export function IndustryCard({
  ...
  const isPriority = emphasizePriority && PRIORITY_FEATURED.has(industry.slug);
  ...
  return (
    ...
    >
      <div className="industries-card__body">
        ...
        <ul className="industries-card__highlights" aria-label={`${industry.label} business goals`}>
          {goals.map((item) => (
            <li key={item}>
