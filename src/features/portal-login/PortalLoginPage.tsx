...
import { PORTAL_LOGIN_LANDING, resolvePortalCallbackUrl } from './portal-login.content';
...
export function PortalLoginPage({ searchParams }: PortalLoginPageProps) {
  const breadcrumbs = buildBreadcrumbs([{ label: 'Home', href: ROUTES.home }, { label: 'Login' }]);
        ...
        <Container size="xl" className="portal-login__container">
          ...
          <div className="portal-login__card">
            <header className="portal-login__card-head">
              <p className="portal-login__eyebrow">{PORTAL_LOGIN_LANDING.eyebrow}</p>
              <h1 id="login-system-title" className="portal-login__title">
                {PORTAL_LOGIN_LANDING.title}
              </h1>
              <p className="portal-login__description">{PORTAL_LOGIN_LANDING.description}</p>
            </header>
