 ...
 */
export function WorkTestimonialDetailPage({
  item,
}: WorkTestimonialDetailPageProps) {
  ...
  return (
    <PageShell className="work-page work-detail-page">
      <WorkInternalHero
        ...
        chips={[item.industry, item.role].filter(
      ...
      >
        ...
        {item.quote ? (
          ...
          <div className="work-detail-quote work-detail-quote--placeholder">
            <p>
              We only publish client quotes after approval. In the meantime,
              explore related delivery work or book a consultation to hear how
              engagements like this run.
            </p>
