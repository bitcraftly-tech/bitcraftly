...
export const WORK_PROJECTS: readonly WorkProject[] = [
  ...
  },
  {
    ...
    summary: 'Premium toy ecommerce demo — age filters, safety trust, and calm cart UX.',
    coverImage: workProductImage('Ecommerce Store.png'),
    coverImageAlt: 'PlayNest premium toy ecommerce showcase screenshot',
    ...
    solution: 'PlayNest-style Next.js storefront with age-first discovery and calm cart.',
    metrics: [
