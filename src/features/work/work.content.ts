...
export const WORK_PROJECTS: readonly WorkProject[] = [
  ...
  },
  {
    ...
    coverImageAlt: 'FitRally gym website — hero, live session bar, and Pick your workout formats',
  ...
  {
    slug: 'playnest-toy-store',
    title: 'PlayNest Toy Store',
    summary: 'Premium toy ecommerce demo — category sidebar, age shop, bestsellers, and calm cart UX.',
    coverImage: workProductImage('PlayNest Toy Store.png'),
    coverImageAlt: 'PlayNest toy store showcase — hero, category sidebar, and trust bar',
    previewHost: 'playnest.showcase',
    badge: 'Interactive demo',
    liveUrl: '/portfolio/toy-showcase',
    liveExternal: true,
    industry: 'Ecommerce',
    industrySlug: 'retail-ecommerce',
    businessGoal: 'Help parents discover safe toys by age with a conversion-ready cart.',
    services: ['Website Development', 'Ecommerce'],
    techStack: ['Next.js', 'React', 'Cart UX', 'Age filters'],
    categories: ['web-applications', 'saas'],
    filterIds: ['web-applications', 'retail'],
    duration: '4–7 weeks',
    timeline: '4–7 weeks to toy commerce demo',
    result: 'Catalog clarity and trust signals reduce parent checkout hesitation.',
    outcome: 'Buyers filter by age, understand safety, and complete demo cart flows.',
    problem: 'Toy storefronts often bury age guidance and safety under clutter.',
    solution: 'Premium D2C-style Next.js toy storefront with category discovery and calm cart.',
    metrics: [
      { id: 'age', value: 'clear', label: 'age-first filters' },
      { id: 'trust', value: 'safety', label: 'parent trust UX' },
    ],
    featured: false,
    year: 2026,
    accent: 'rose',
    seoTitle: 'PlayNest Toy Store | Work',
    seoDescription: 'Premium toy ecommerce showcase with age filters and cart UX by Bitcraftly.',
  },
  {
...
export const WORK_HUBS: readonly WorkHubContent[] = [
  ...
  },
  {
    ...
    filterPreset: 'latest',
    seoTitle: 'Latest Work | Work',
    seoDescription: 'Recently shipped Bitcraftly websites, apps, and platforms.',
  },
  {
    slug: 'enterprise',
    title: 'Enterprise Projects',
    description: 'Complex systems for regulated and global teams.',
    filterPreset: 'enterprise',
    seoTitle: 'Enterprise Projects | Work',
    seoDescription: 'Enterprise Bitcraftly systems for multi-role and regulated teams.',
  },
  {
    slug: 'healthcare',
    title: 'Healthcare',
    description: 'Compliant digital products for care teams.',
    filterPreset: 'healthcare',
    seoTitle: 'Healthcare Case Studies | Work',
    seoDescription: 'Healthcare websites and products built for trust and appointment clarity.',
  },
  {
    slug: 'education',
    title: 'Education',
    description: 'Learning platforms and student experiences.',
    filterPreset: 'education',
    seoTitle: 'Education Case Studies | Work',
    seoDescription: 'Education and campus websites engineered for enrolment enquiries.',
  },
  {
    slug: 'fintech',
    title: 'FinTech',
    description: 'Payments, lending, and wealth platforms.',
    filterPreset: 'fintech',
    seoTitle: 'FinTech Case Studies | Work',
    seoDescription: 'FinTech and finance product experiences with operator controls.',
  },
  {
    slug: 'retail',
    title: 'Retail',
    ...
    filterPreset: 'retail',
    seoTitle: 'Retail Case Studies | Work',
    seoDescription: 'Retail and ecommerce storefronts built to convert.',
  },
  {
    slug: 'logistics',
    title: 'Logistics',
    description: 'Tracking, fulfillment, and supply chain.',
    filterPreset: 'logistics',
    seoTitle: 'Logistics Case Studies | Work',
    seoDescription: 'Logistics and fulfillment tools focused on operational clarity.',
  },
  {
    slug: 'websites',
    title: 'Websites',
    description:
      'Marketing and product websites engineered to convert — clear offers, fast pages, and enquiry paths that hold up on mobile.',
    filterPreset: 'websites',
    seoTitle: 'Websites | Work',
    seoDescription:
      'Browse Bitcraftly website work — conversion-focused marketing sites for clinics, schools, retail, and service brands.',
  },
  {
  ...
  },
  {
    ...
    filterPreset: 'mobile-apps',
    seoTitle: 'Mobile Apps | Work',
    seoDescription: 'Bitcraftly mobile app portfolio and delivery notes.',
  },
  {
    slug: 'ai-solutions',
    title: 'AI Solutions',
    description:
      'Assistants, automation, and AI products that deflect busywork — with human handoff when intent is high.',
    filterPreset: 'ai',
    seoTitle: 'AI Solutions | Work',
    seoDescription:
      'Bitcraftly AI solutions work — assistants, automation, and product copilots with measurable ops outcomes.',
  },
  {
    slug: 'case-studies',
    title: 'Case Studies',
    ...
    filterPreset: 'featured',
    seoTitle: 'Case Studies | Work',
    seoDescription: 'In-depth Bitcraftly delivery stories by industry and outcome.',
  },
  {
    ...
    filterPreset: 'featured',
    seoTitle: 'Client Success Stories | Work',
    seoDescription: 'Client success stories and long-term partnership outcomes.',
  },
  {
    slug: 'testimonials',
    title: 'Testimonials',
    ...
    filterPreset: 'featured',
    seoTitle: 'Testimonials | Work',
    seoDescription: 'Approved client testimonials across industries and engagements.',
  },
  {
    slug: 'outcomes',
    title: 'Business Outcomes',
    ...
    filterPreset: 'all',
    seoTitle: 'Business Outcomes | Work',
    seoDescription: 'Measurable business outcomes from Bitcraftly delivery programs.',
  },
] as const;
