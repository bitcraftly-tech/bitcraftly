...
export const WORK_PROJECTS: readonly WorkProject[] = [
  {
    ...
    summary:
      "Live cloud kitchen experience — menu discovery built for WhatsApp-first orders.",
    ...
    solution:
      "Thumb-first Next.js storefront with menu discovery and WhatsApp order handoff.",
    metrics: [
    ...
    seoDescription:
      "Live cloud kitchen website with WhatsApp-first menu discovery by Bitcraftly.",
  },
  {
    slug: "swastik-makhana",
    title: "Swastik Makhana",
    summary:
      "Live D2C brand storefront — premium makhana packs, cart flows, and NCR delivery.",
    ...
    seoDescription:
      "Live D2C makhana ecommerce storefront engineered by Bitcraftly.",
  },
  {
    slug: "kunwar-dairy",
    title: "Kunwar Dairy",
    summary:
      "Live dairy brand — farm-fresh milk, ghee, and subscription delivery across Bihar.",
    ...
    seoDescription:
      "Live dairy brand website with subscription UX by Bitcraftly.",
  },
  {
    ...
    solution:
      "Bitcraftly future build: typed Next.js SaaS shell with billing-ready analytics UX.",
    metrics: [
  ...
  },
  {
    ...
    liveUrl: "https://bitcraftly.com/portfolio/clinic-healthcare-showcase",
    liveExternal: true,
    industry: "Healthcare",
    ...
    seoDescription:
      "Healthcare clinic website showcase for trust and appointment enquiries.",
  },
  {
    slug: "school-website",
    ...
    badge: "Interactive demo",
    liveUrl: "https://bitcraftly.com/portfolio/school-website-showcase",
    liveExternal: true,
    industry: "Education",
    ...
    seoDescription:
      "Education admissions website showcase engineered by Bitcraftly.",
  },
  {
    slug: "gym-website",
    title: "Gym Website",
    summary:
      "Fitness brand demo — trials, classes, and membership enquiry paths that convert.",
    coverImage: workProductImage("Gym Website.png"),
    coverImageAlt: "Gym website fitness brand screenshot",
    previewHost: "gym.showcase",
    badge: "Interactive demo",
    liveUrl: "https://bitcraftly.com/portfolio",
    liveExternal: true,
    industry: "Fitness",
  ...
  },
  {
    ...
    summary:
      "AI menu answers with seamless human handoff on WhatsApp when intent is high.",
    ...
    badge: "Interactive demo",
    liveUrl: "https://bitcraftly.com/portfolio/restaurant-ai-chatbot-showcase",
    liveExternal: true,
    industry: "AI",
    industrySlug: "hospitality",
    ...
    seoDescription:
      "Restaurant AI chatbot with WhatsApp human handoff by Bitcraftly.",
  },
  {
    slug: "ecommerce-store",
    title: "Ecommerce Store",
    summary:
      "Ecommerce demo — catalog clarity, checkout trust, and COD-friendly flows.",
    coverImage: workProductImage("Ecommerce Store.png"),
    coverImageAlt: "Ecommerce store catalog screenshot",
  ...
  },
  {
    ...
    summary:
      "Real estate demo — project gallery that builds enquiry trust for buyers.",
  ...
  },
  {
    ...
    summary:
      "Resident portal demo — notices, forms, and lightweight ops workflows.",
  ...
  },
  {
    ...
    summary:
      "Training institute demo — courses, document verification, and franchise paths.",
  ...
  },
  {
    ...
    summary:
      "Local services demo — high-intent CTAs for coaches, consultants, and pros.",
    ...
    seoDescription:
      "Local services landing page showcase optimized for high-intent leads.",
  },
] as const;
...
export const WORK_CASE_STUDIES: readonly WorkCaseStudy[] = [
  {
    ...
    title: "SaaSPro Dashboard",
    description:
      "Future SaaS control plane with analytics, billing UX, and operator workflows.",
    challenge:
      "Founders need a production-shaped dashboard before committing to full build.",
    approach:
      "Typed Next.js SaaS shell with Stripe-ready billing UI and analytics patterns.",
...
export const WORK_PROCESS_COPY = {
  ...
  heading:
    "A transparent engineering process from discovery to long-term success.",
  description:
...
export const WORK_RELATED_COPY = {
  ...
  description:
    "Explore the services and solutions most often connected to the work we ship.",
} as const;
