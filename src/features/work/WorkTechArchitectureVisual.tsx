...
export function WorkTechArchitectureVisual() {
  return (
    <div className="work-tech__architecture work-tech__glass" aria-hidden="true">
      ...
      >
        <defs>
          ...
          <linearGradient id="work-tech-node" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop
              offset="100%"
              stopColor="color-mix(in srgb, var(--primary) 8%, var(--background))"
            />
          </linearGradient>
        </defs>
        ...
        <path
          ...
          strokeDasharray="5 6"
        />
        <path d="M180 60 V200" fill="none" stroke="url(#work-tech-line)" strokeWidth="2" />
        ...
        <g>
          <rect
            ...
            height="48"
            rx="14"
            fill="url(#work-tech-node)"
            stroke="color-mix(in srgb, var(--primary) 28%, var(--border))"
          />
          <text x="70" y="57" textAnchor="middle" className="work-tech__diagram-label">
            Edge
          </text>
          <text x="70" y="72" textAnchor="middle" className="work-tech__diagram-sub">
            CDN · TLS
          </text>
        </g>
        <g>
          <rect
            ...
            stroke="color-mix(in srgb, var(--primary) 28%, var(--border))"
          />
          <text x="180" y="119" textAnchor="middle" className="work-tech__diagram-label">
            API
          </text>
          <text x="180" y="134" textAnchor="middle" className="work-tech__diagram-sub">
            REST · GQL
          </text>
        </g>
        <g>
          ...
          />
          <text x="290" y="57" textAnchor="middle" className="work-tech__diagram-label">
            App
          </text>
          <text x="290" y="72" textAnchor="middle" className="work-tech__diagram-sub">
            Next.js
          </text>
        </g>
        <g>
          <rect
            ...
            rx="14"
            fill="url(#work-tech-node)"
            stroke="color-mix(in srgb, var(--success) 30%, var(--border))"
          />
          <text x="290" y="197" textAnchor="middle" className="work-tech__diagram-label">
            Data
          </text>
          <text x="290" y="212" textAnchor="middle" className="work-tech__diagram-sub">
            Postgres
          </text>
        </g>
        <g>
          <rect
            ...
            stroke="color-mix(in srgb, var(--primary) 28%, var(--border))"
          />
          <text x="70" y="197" textAnchor="middle" className="work-tech__diagram-label">
            AI
          </text>
          <text x="70" y="212" textAnchor="middle" className="work-tech__diagram-sub">
            Assist
          </text>
        </g>
        ...
        <g>
          <rect
            ...
            height="26"
            rx="13"
            fill="color-mix(in srgb, var(--primary) 8%, var(--background))"
