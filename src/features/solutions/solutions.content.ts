...
type SolutionOverride = Partial<
  Omit<
    SolutionPageContent,
    "slug" | "label" | "icon" | "groupId" | "groupTitle" | "summary"
  >
> & {
...
const CONTENT_OVERRIDES: Record<string, SolutionOverride> = {
  ...
  cms: {
    metaDescription:
      "CMS solutions by Bitcraftly — flexible content platforms for growth teams.",
    eyebrow: "Business Solutions",
  ...
  "ai-workflows": {
    metaDescription:
      "AI workflows by Bitcraftly — orchestrated AI steps across your systems.",
    eyebrow: "AI Solutions",
...
export function getSolutionPageContent(
  slug: string,
