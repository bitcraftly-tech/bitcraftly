...
export const CAREER_ROLES_ARCHIVE: readonly CareerRole[] = [
  {
    ...
    summary: 'Own client-facing product UIs end-to-end — architecture, reviews, and shipping.',
    team: 'engineering',
    level: 'senior',
    experience: '5+ years',
  ...
  },
  {
    ...
    summary: 'Shape frontend standards across Bitcraftly projects and mentor the team.',
    team: 'engineering',
    level: 'lead',
    experience: '8+ years',
    employment: 'Full-time',
  ...
  },
  {
    ...
    summary: 'Build fast marketing sites, dashboards, and SaaS shells for SMB clients.',
    team: 'engineering',
    level: 'mid',
  ...
  },
  {
    slug: 'ui-engineer',
    title: 'UI Engineer',
    summary: 'Bridge design and code — pixel-perfect, accessible, animated interfaces.',
    team: 'engineering',
    level: 'mid',
  ...
  },
  {
    ...
    summary: 'Ship AI-powered web experiences — chat UIs, copilots, and automation dashboards.',
    team: 'engineering',
    level: 'senior',
    experience: '4+ years',
    employment: 'Full-time',
  ...
  },
  {
    ...
    summary: 'Lead discovery → delivery for client products with a founder-led review loop.',
    team: 'design',
    level: 'mid',
