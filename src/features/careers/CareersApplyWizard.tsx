...
export function CareersApplyWizard() {
  ...
  useEffect(() => {
    ...
    if (draft) {
      ...
      setCompletedSteps(
        new Set(draft.completedSteps.filter((id) => id >= 1 && id <= 5)),
      );
    }
    setDraftReady(true);
  }, [reset, roleParam]);
  ...
  const selectedTitle = useMemo(() => {
    ...
    return (
      CAREER_ROLES.find((role) => role.slug === values.roleSlug)?.title ??
      "General application"
    );
  }, [values.roleSlug]);
  ...
  function persistDraft(
    nextStep: number,
    nextCompleted: ReadonlySet<number>,
  ): void {
    writeDraft({
      step: nextStep,
  ...
  if (submitted) {
    return (
      <div className="careers-apply-wizard__success" role="status" aria-live="polite">
        ...
        <p>
          Thanks — Sanjay reviews every application personally. We’ll reply by
          email if there’s a fit.
        </p>
  ...
  return (
    ...
    >
      <div className="careers-apply-wizard__progress" aria-hidden>
        <div
          className="careers-apply-wizard__progress-fill"
      ...
      <div
        ...
        className="careers-apply-wizard__tabs sliding-pill-track"
      >
      ...
      >
        {currentStepMeta ? (
          <div className="careers-apply-wizard__panel-head">
            <div className="careers-apply-wizard__panel-title-row">
              ...
              <h2 className="careers-apply-wizard__panel-title">
                {currentStepMeta.title}
              </h2>
            </div>
            <p className="careers-apply-wizard__panel-hint">
        ...
        {step === 3 ? (
          <div className="careers-apply__grid">
            ...
            <div className="careers-apply__field">
              <Label htmlFor="careers-current-salary">
        ...
        {step === 4 ? (
          <div className="careers-apply__grid">
            ...
            <div className="careers-apply__field careers-apply__field--full">
              <Label htmlFor="careers-projects">
