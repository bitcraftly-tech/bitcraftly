...
export const ABOUT_HERO = {
  ...
  supporting:
    "Delhi NCR–based. Serving founders, CTOs, and operators across India and remote.",
  primaryCta: {
...
export const ABOUT_TESTIMONIALS: readonly AboutTestimonialPlaceholder[] = [
  {
    id: "t1",
    quote:
      "Testimonial placeholder — replace with an approved client quote after permission.",
