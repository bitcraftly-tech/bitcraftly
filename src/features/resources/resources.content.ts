...
export const RESOURCES_GUIDES: ResourceTopicPageContent = {
  ...
  seoDescription:
    "Practical playbooks for product and engineering teams building with Bitcraftly.",
      ...
      items: [
        {
          ...
          description:
            "Keep demos useful, blockers visible, and scope changes intentional.",
          icon: "zap",
          tags: ["Process"],
        },
        {
          ...
          description:
            "What to leave behind so your team can operate and extend the product.",
          icon: "check",
          tags: ["Ops"],
        },
        {
          ...
          description:
            "SEO, analytics, access, monitoring, and support paths before go-live.",
          icon: "rocket",
          tags: ["Launch"],
        },
      ],
  ...
  sections: [
    {
      ...
      description:
        "Opinionated starting points for Next.js, FastAPI, and PostgreSQL products.",
      items: [
        {
          id: "next-app-router",
          title: "Next.js App Router patterns",
          description:
            "Server Components first, thin routes, and feature-owned UI modules.",
          icon: "globe",
          tags: ["Frontend"],
        },
        {
          ...
          description:
            "Auth, validation, and module boundaries for maintainable backends.",
          icon: "database",
          tags: ["Backend"],
        },
        {
          ...
          description:
            "Practical schema choices for multi-tenant and operator products.",
          icon: "code",
          tags: ["Data"],
        },
      ],
      ...
      items: [
        {
          ...
          description:
            "WCAG-oriented defaults for keyboard, focus, semantics, and motion.",
          icon: "shield",
          tags: ["A11y"],
        },
        {
          ...
          description:
            "Image, bundle, and rendering choices that keep marketing pages fast.",
          icon: "zap",
          tags: ["Performance"],
        },
        {
          ...
          description:
            "Titles, canonicals, breadcrumbs, and JSON-LD patterns we reuse.",
          icon: "trending-up",
          tags: ["SEO"],
        },
      ],
...
export function getResourceTopicBySlug(
  slug: string,
): ResourceTopicPageContent | undefined {
