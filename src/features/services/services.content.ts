...
const DEFAULT_PROCESS = [
  {
    title: "Discovery",
    description:
      "Goals, audience, constraints, and success metrics — written before build starts.",
  },
  {
    title: "Solution design",
    description:
      "Scope, architecture, timeline, and a clear estimate in plain language.",
  },
  {
    title: "Build & iterate",
    description:
      "Founder-led delivery with reviews on real progress — not slide decks.",
  },
  {
    title: "Launch & support",
    description:
      "Go-live checklist, handoff, and optional ongoing care.",
  },
] as const;
...
const CONTENT_OVERRIDES: Record<string, ServiceContentOverride> = {
  ...
  "document-ai": {
    metaDescription:
      "Document AI — extract, classify, and process documents with Bitcraftly.",
    eyebrow: "AI & Automation",
  ...
  "custom-software-development": {
    metaDescription:
      "Custom software — ERP, CRM, CMS, and internal tools tailored by Bitcraftly.",
    eyebrow: "Development",
  ...
  "website-maintenance": {
    metaDescription:
      "Website maintenance — updates, reliability, and ongoing care by Bitcraftly.",
    eyebrow: "Digital Growth",
...
export function getServicePageContent(
  ...
  return {
    ...
    metaDescription:
      ...
      `${nav.label} by Bitcraftly — ${nav.description}`,
...
const SERVICE_CARD_BADGES: Partial<
  Record<string, ServiceCardModel["badge"]>
> = {
...
export function getServiceCardModels(): readonly ServiceCardModel[] {
  return ALL_SERVICES.map((service) => ({
    ...
    ctaLabel: "Learn More",
    badge:
      SERVICE_CARD_BADGES[service.slug] ?? ("Recommended" as const),
...
export const SERVICES_LANDING = {
  ...
  trendingServices: [
    ...
    { label: "Web Applications", href: "/services/web-application-development", icon: "code" as const },
    { label: "AI Automation", href: "/services/ai-automation", icon: "zap" as const },
    { label: "Custom Software", href: "/services/custom-software-development", icon: "database" as const },
    { label: "Performance", href: "/services/performance-optimization", icon: "trending-up" as const },
  ] as const,
  featuredByGroup: [
    {
