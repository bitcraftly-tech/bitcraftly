...
import { SERVICES_FAQ, SERVICES_FAQ_META } from './services-landing.content';

/**
 * Services landing FAQ — canonical FaqAccordion treatment.
 */
export function ServicesLandingFaq() {
  return (
    <Section
      id="services-faq"
      spacing="lg"
    ...
    >
      <div className="flex flex-col gap-[var(--space-4)] sm:flex-row sm:items-end sm:justify-between">
        <header className="max-w-2xl">
          ...
          >
            {SERVICES_FAQ_META.description}
          </p>
        </header>
        <Link
          href={SERVICES_FAQ_META.viewAllHref}
          className={cn(
        ...
        >
          {SERVICES_FAQ_META.viewAllLabel}
