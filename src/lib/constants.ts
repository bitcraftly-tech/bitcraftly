/**
 * Shared layout + contact constants for portfolio showcases and legacy pages.
 * Kept self-contained (no siteContent dependency).
 */
...
export const PAGE_SHELL =
  'flex min-h-dvh w-full min-w-0 flex-1 flex-col bg-transparent text-foreground';
...
/**
 * Padding-top below the marketing breadcrumb bar.
 * Single spacing owner: first content block padding-top.
 */
...
/** Support / footer — reused by chat fallback & portfolio demos */
...
export const PRIMARY_LOCATION = 'Noida, Uttar Pradesh, India';
export const WHATSAPP_HOURS = 'Mon–Sat · 10:00–19:00 IST';

export const WHATSAPP_DEFAULT_MESSAGE =
  "Hi Sanjay — I'd like to discuss a project with Bitcraftly.";

/** Override via `NEXT_PUBLIC_FOUNDER_LINKEDIN_URL` in .env.local */
export const FOUNDER_LINKEDIN_URL =
  process.env.NEXT_PUBLIC_FOUNDER_LINKEDIN_URL ?? 'https://www.linkedin.com/in/uideveloper09/';
