...
export const PORTFOLIO_LIGHT_WRAPPER =
  'portfolio-showcase-light text-[#2c3e50] dark:text-dark-text-primary';

export const PS_SECTION = 'relative overflow-hidden rounded-none bg-[#fafbfc]';
...
export const PS_CARD = 'ps-card group relative flex h-full flex-col';
...
export const PS_HEADING =
  'font-[var(--font-playfair)] text-3xl font-semibold tracking-tight text-[#2c3e50] sm:text-4xl md:text-[2.75rem]';
