...
function lightShowcaseTheme(config: {
  ...
  return {
    ...
    shell:
      'portfolio-showcase-light flex min-h-screen flex-col bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100',
      ...
      },
      {
        ...
        links: [
          { label: 'Delivery strip', href: '#menu' },
          {
            ...
            href: '/contact?intent=restaurant&source=restaurant-showcase',
          },
        ],
      },
    ],
