...
export const RPYTECH_TESTIMONIALS = [
  {
    ...
    role: 'Safety Officer',
    quote:
      'RPYTech helped me build a great career in the safety industry. Excellent training and support!',
  },
  {
    name: 'Neha Yadav',
    role: 'QA/QC Engineer',
    quote: 'The practical training and placement support is outstanding. Thank you RPYTech!',
  },
  {
    name: 'Mohit Singh',
    role: 'NDT Technician',
    quote: 'I got placed in a top MNC after completing my NDT course from RPYTech.',
  },
  {
    name: 'Pooja Sharma',
    role: 'Piping Engineer',
    quote: 'Best institute for industrial training. Highly recommended!',
  },
] as const;

export const RPYTECH_FOOTER_QUICK = [
  'Home',
  'About Us',
  'Courses',
  'Student Zone',
...
export const RPYTECH_FOOTER_VERIFY = [
