...
export type PortfolioMockup =
  'restaurant' | 'school' | 'gym' | 'ecommerce' | 'chatbot' | 'clinic' | 'local' | 'generic';
...
const defaultCaseStudy = (overrides: Partial<PortfolioCaseStudy>): PortfolioCaseStudy => ({
  problem:
    'Visitors were not converting — unclear offers, weak mobile UX, and no structured path to enquire.',
  solution:
    'A modern, mobile-first experience with clear CTAs, trust sections, and WhatsApp-ready contact flows.',
  results: [
    'Clearer user journey',
    'Faster mobile experience',
    'Structured SEO pages',
    'Easier enquiry handoff',
  ],
  beforeLabel: 'Before',
  afterLabel: 'After (Bitcraftly build)',
  beforePoints: [
    'Generic layout',
    'Slow or cluttered mobile',
    'Weak CTA placement',
...
export const homePortfolioItems: PortfolioItem[] = [
  {
    ...
    caseStudy: defaultCaseStudy({
      problem:
        'Customers needed a faster way to browse menus and reach the kitchen without phone tag.',
      solution:
        'Menu-led website with mobile-first layout, local trust cues, and direct WhatsApp order handoff.',
      results: [
        'Clear menu discovery',
        'Mobile-friendly ordering path',
        'Local SEO structure',
        'WhatsApp-ready CTAs',
      ],
      beforePoints: [
        'Menu scattered on social posts',
        'No dedicated mobile ordering flow',
        'Weak local discovery',
      ],
      afterPoints: [
        'Structured menu UX',
        'One-tap WhatsApp order path',
        'Trust-first local brand page',
      ],
      performance: [
  ...
  },
  {
    ...
    featureBullets: [
      'Pack-size catalog',
      'Cart & checkout UX',
      'GI-tagged brand trust',
      'NCR delivery messaging',
    ],
    ...
    caseStudy: defaultCaseStudy({
      ...
      performance: [
        {
          label: 'Catalog',
          value: 'Pack-led',
          note: '100g–250g sizes with clear MRP & offer pricing',
        },
        {
          label: 'Mobile',
          value: 'First',
          note: 'Shopping and storytelling tuned for phone buyers',
        },
      ...
      trustNote:
        'Production client site at swastikmakhana.co — same ecommerce delivery standards we offer D2C brands.',
    }),
  },
  {
    title: 'Kunwar Dairy',
    hint: 'Farm-fresh delivery, milk subscriptions & dairy ecommerce',
    cardLine: 'Live dairy brand — farm-fresh milk, ghee & subscription delivery across Bihar',
    mobileCardLine: 'Live site · milk subscription + Bihar delivery',
    projectFocus: 'Next.js',
    gradient: 'from-sky-500/20 to-emerald-500/10',
    emoji: '🥛',
    mockup: 'ecommerce',
    image: '/products/dairy-farm.png',
    featureBullets: [
      'Milk subscription UX',
      'Razorpay auto-pay',
      'Farm-to-home storytelling',
      'Bihar delivery trust',
    ],
    ...
    resultHighlight: 'Farm-fresh dairy subscription — daily delivery, pause anytime, no lock-in',
    caseStudy: defaultCaseStudy({
      problem:
        'A Bihar dairy farm needed more than a brochure site — customers wanted daily milk delivery, subscriptions, and clear product pages for ghee, dahi, paneer & chaach without calling every morning.',
      solution:
        'Full dairy ecommerce with subscription flows (daily · weekly · custom), Razorpay UPI/card auto-pay, pause & vacation mode, and farm-to-home brand storytelling in Hindi-English mix.',
      results: [
        'Subscribe-to-milk funnel with no lock-in',
        'Product shop for milk, ghee, curd, paneer & chaach',
        'Same-day Bihar delivery messaging',
        'Newsletter & farm-fresh trust content',
      ],
      beforePoints: [
        'Orders relied on phone calls and WhatsApp chaos',
        'No structured subscription or pause controls',
        'Weak online trust for farm-fresh positioning',
      ],
      afterPoints: [
        'Doorstep subscription with Razorpay auto-pay',
        'Clear dairy catalog with premium farm narrative',
        'Bihar-wide delivery & contact trust signals',
      ],
      performance: [
        {
          label: 'Subscription',
          value: 'Flexible',
          note: 'Daily · weekly · custom — pause anytime',
        },
        { label: 'Mobile', value: 'First', note: 'Morning delivery buyers on phone' },
        { label: 'Trust', value: 'Farm-led', note: 'शुद्ध दूध — Shree Shyam Dairy Farm story' },
      ],
      overview:
        'Live site for Kunwar Dairy — farm-fresh milk and dairy products with subscription delivery across Bihar, built for daily doorstep orders and premium ghee/dahi sales.',
      client: 'Kunwar Dairy (Shree Shyam Dairy Farm)',
      timeline: 'Live production',
      categoryLabel: 'Ecommerce · Dairy subscription',
      services: ['Next.js storefront', 'Subscription UX', 'Product catalog', 'Mobile optimization'],
      headlineMetrics: [
        { value: 'Daily', label: 'Delivery cadence', icon: 'clock' },
        { value: '5+', label: 'Dairy categories', icon: 'target' },
        { value: 'Bihar', label: 'Service region', icon: 'zap' },
      ],
      trustNote:
        'Production client site at kunwardairy.com — same subscription & ecommerce standards we offer D2C food brands.',
    }),
  },
  {
    title: 'Gym Website',
    ...
    caseStudy: defaultCaseStudy({
      ...
      results: [
        'Trial offer above the fold',
        'Class schedule clarity',
  ...
  },
  {
    ...
    caseStudy: defaultCaseStudy({
      problem:
        'Parents could not quickly find admissions info, notices, and contact paths on older school sites.',
      solution:
        'Admission-focused layout with notices, downloads, and enquiry forms scoped for parent journeys.',
      results: [
        'Clear admission CTA',
        'Notices & calendar structure',
        'Mobile-readable content hierarchy',
      ],
    }),
  },
  {
    ...
    caseStudy: defaultCaseStudy({
      problem:
        'Small stores lose sales when catalog browsing and checkout steps feel cluttered on mobile.',
      solution:
        'Category-led storefront with trust badges, delivery/COD messaging, and simplified checkout path.',
      results: [
        'Clear product discovery',
        'Mobile checkout patterns',
        'Payment-ready UX scaffolding',
      ],
      beforePoints: ['Flat product lists', 'Unclear shipping/COD info', 'Heavy checkout friction'],
      afterPoints: [
        'Category navigation',
        'Trust & delivery messaging',
  ...
  },
  {
    ...
    caseStudy: defaultCaseStudy({
      ...
      results: ['Age-first discovery', 'Parent trust messaging', 'Conversion-ready cart patterns'],
...
const portfolioExtras: PortfolioItem[] = [
  {
    ...
    details:
      'Trust-first pages for builders — project showcases and enquiry flows scoped to how you sell.',
    caseStudy: defaultCaseStudy({
      problem:
        'Builders relied on PDFs and phone calls — projects were not showcased with modern mobile credibility.',
      solution:
        'Project gallery, enquiry forms, and trust sections without turning the site into a listings portal.',
    }),
  },
  {
    ...
    details:
      'Lightweight resident-facing sites — notices, forms and handoffs scoped to committee needs.',
    caseStudy: defaultCaseStudy({
      problem:
        'Societies needed resident-facing clarity without buying an oversized management suite.',
      solution:
        'Focused portal patterns for notices, forms, and WhatsApp-friendly resident communication.',
    }),
  },
  {
    ...
    details:
      'Customer-facing assistant for menus, hours, and quick questions — with clean handoff to staff or WhatsApp.',
    caseStudy: defaultCaseStudy({
      overview:
      ...
      problem:
        'Staff repeated the same menu and hours questions — wasting time on low-value calls.',
      solution:
        'AI-assisted FAQ layer with structured menu answers and WhatsApp escalation when humans are needed.',
      results: [
        'Faster FAQ resolution',
        'Staff time saved on repeat questions',
        'WhatsApp handoff preserved',
      ],
      beforePoints: ['Manual replies only', 'No structured menu Q&A', 'Leads lost after hours'],
      afterPoints: [
        'Instant menu/hours answers',
  ...
  },
  {
    ...
    caseStudy: defaultCaseStudy({
      problem:
        'Clinics lost patient trust online when sites looked outdated or hid appointment options.',
      solution:
        'Credible healthcare layout with doctor profiles, services, and secure appointment enquiry flows.',
    }),
  },
  {
    ...
    caseStudy: defaultCaseStudy({
      problem:
        'Training institutes need credible sites with verification, course discovery, and placement proof.',
      solution:
        'Full homepage mock aligned to rpytech.in — hero, stats, courses, gallery, franchise & contact.',
  ...
  },
  {
    ...
    caseStudy: defaultCaseStudy({
      problem:
        'Coaches and local pros depended on Instagram alone — no structured funnel to capture leads.',
      solution:
        'Lead-focused site with service clarity, social proof placeholders, and WhatsApp-first contact.',
    }),
  },
  {
    title: 'Online Crockery Shop',
    hint: 'Premium tableware catalog & checkout-ready UX',
    cardLine: 'Crockery Wala demo — elegant tableware storefront & shopping flows',
    mobileCardLine: 'Crockery demo · Crockery Wala tableware shop',
    projectFocus: 'Next.js',
    gradient: 'from-amber-600/15 to-stone-500/10',
    emoji: '🍽️',
    mockup: 'ecommerce',
    image: '/products/online-crockery-shop.png',
    featureBullets: ['Premium catalog UX', 'Collections-led browse', 'Trust & shipping cues'],
    demoHref: '/portfolio/claycraft-crockery-showcase',
    ctaLabel: 'Open interactive demo →',
    tag: 'Ecommerce',
    categories: ['ecommerce', 'react-nextjs'],
    badge: 'Interactive demo',
    techStack: ['Next.js', 'React', 'Ecommerce UX', 'Tableware UI'],
    resultHighlight: 'Warm premium retail UI for dinnerware discovery',
    details:
      'Crockery Wala elegant tableware showcase — refined header, footer, and upcoming catalog sections.',
    caseStudy: defaultCaseStudy({
      problem: 'Tableware brands need a calm premium storefront that still converts on mobile.',
      solution:
        'Warm clay-gold ecommerce shell with clear navigation, trust signals, and shopping affordances.',
      results: ['Premium brand framing', 'Clear category paths', 'Checkout-ready scaffolding'],
    }),
  },
  {
    ...
    details:
      'Showcase of modern React UI patterns for founders who need investor-ready product screens.',
    caseStudy: defaultCaseStudy({
      problem: 'Startups needed polished UI fast without hiring a full product team.',
      solution:
        'React-based product demo illustrating scalable components, states, and dashboard-ready layouts.',
      results: [
        'Reusable UI patterns',
        'Investor-demo ready screens',
