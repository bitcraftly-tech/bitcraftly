    ...
    <header id="top" className={`${poppins.className} sticky top-0 z-50`}>
      <div className="rpytech-top-bar">
        <div className={`${RPYTECH_CONTAINER} rpytech-bar-row`}>
          <span className="rpytech-bar-row-start">
      ...
      <nav className="rpytech-main-nav">
        <div className={`${RPYTECH_CONTAINER} rpytech-nav-row`}>
          <button
            type="button"
            onClick={() => go('top')}
            className="rpytech-nav-row-start text-left"
          >
            <RpytechBrandLockup />
          </button>
            ...
            {RPYTECH_NAV.map((item) => {
              ...
              return (
                <li
                  ...
                  className={
                    item.children
                      ? `rpytech-nav-drop${isOpen ? ' rpytech-nav-drop--open' : ''}`
                      : undefined
                  }
                ...
                >
                  ...
                  >
                    {item.label}
                    {item.children ? (
                      <ChevronDown className="rpytech-nav-chevron" aria-hidden />
                    ) : null}
                  </button>
