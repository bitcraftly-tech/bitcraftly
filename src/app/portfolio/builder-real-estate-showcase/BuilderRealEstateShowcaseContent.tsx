...
const FEATURES = [
  {
    ...
    desc: 'Transit-linked corridors with curated retail & hospitality pockets.',
    icon: MapPin,
  },
  {
    title: 'Modern Architecture',
    desc: 'Glass-forward envelopes tuned for daylight, breeze stacks & skyline rhythm.',
    icon: Building2,
  },
  {
    title: 'Smart Homes',
    desc: 'Scene-aware automation, leak sensing & concierge-linked resident apps.',
    icon: Cpu,
  },
  {
    title: '24×7 Security',
    desc: 'Multi-tier access control with CCTV analytics & patrol choreography.',
    icon: Shield,
  },
  {
    title: 'Clubhouse',
    desc: 'Executive lounges, spa suites & skyline banquet decks.',
    icon: Waves,
  },
  {
    title: 'Parking',
    desc: 'Triple-stack bays · EV-ready feeders · valet-ready loops.',
    icon: Car,
  },
] as const;
...
const ONGOING = [
  {
    name: 'Helios Wharf · Wing B',
    eta: 'Handover Q4 2027',
    units: '186 residences · marina podium',
    tone: 'from-blue-900/35 to-slate-100',
  },
  {
    name: 'Nimbus Arcade · Retail spine',
    eta: 'Shell-ready Q2 2026',
    units: 'Double-height storefronts · anchor bays',
    tone: 'from-purple-900/35 to-slate-100',
  },
  {
    name: 'Cascade Villas · Phase II',
    eta: 'Finishes underway',
    units: '34 courtyard villas · private plunge pools',
    tone: 'from-teal-900/25 to-slate-100',
  },
] as const;

const VILLAS = [
  {
    type: 'Signature courtyard villa · V8',
    area: '5,850 sq.ft · triple-height foyer',
    plot: 'Corner podium parcel · lake hinge',
    tone: 'from-amber-800/30 via-violet-100 to-slate-100',
  },
  {
    type: 'Garden pavilion villa · V6',
    area: '4,920 sq.ft · wrap terraces',
    plot: 'Internal landscaped spine',
    tone: 'from-orange-900/28 to-slate-100',
  },
  {
    type: 'Sky villa duplex · SV3',
    area: '6,400 sq.ft · private elevator lobby',
    plot: 'Crown plate · dual aspect glass',
    tone: 'from-fuchsia-900/28 to-slate-100',
  },
] as const;

const APARTMENTS = [
  {
    cfg: 'Sky Junior · 3 BHK',
    carpet: '1,980 sq.ft · dual balconies',
    deck: 'East–west breeze stack · acoustic glazing',
    tone: 'from-violet-900/40 to-slate-100',
  },
  {
    cfg: 'Executive aerie · 4 BHK + study',
    carpet: '2,640 sq.ft · corner bay windows',
    deck: 'Sky lounge access · private foyer airlock',
    tone: 'from-indigo-900/45 to-slate-100',
  },
  {
    cfg: 'Penthouse observatory',
    carpet: '4,100 sq.ft · wrap terrace + plunge',
    deck: 'Helipad-ready crown · wine gallery',
    tone: 'from-amber-950/40 to-slate-100',
  },
] as const;
...
const FLOOR_PLANS = [
  {
    name: 'Typical · 3 BHK Sky Junior',
    sq: '1,980 sq.ft carpet',
    note: 'Split bedroom privacy · service core isolation',
    ratio: '18 : 82 · living-to-private',
  },
  {
    name: 'Corner · 4 BHK Executive',
    sq: '2,640 sq.ft carpet',
    note: 'Dual aspect bay · pantry ducted extract',
    ratio: 'Wide deck · cross ventilation',
  },
  {
    name: 'Sky duplex · Observatory',
    sq: '4,100 sq.ft carpet + terrace',
    note: 'Private lift vestibule · staff quarters module',
    ratio: 'Terrace-first entertaining',
  },
] as const;
...
function PropertyCard({
  ...
  return (
    <article
      className={`overflow-hidden rounded-2xl border border-dark-border-primary bg-gradient-to-br shadow-xl ring-1 ring-amber-500/10 ${tone}`}
    >
      <div className="relative min-h-[200px] border-b border-slate-200/80 bg-white/80 p-6 backdrop-blur-sm">
        ...
        <h3 className="mt-4 font-[var(--font-playfair)] text-xl font-semibold text-white">
          {name}
        </h3>
      ...
      <div className="flex items-center justify-between bg-white/90 px-6 py-4">
        ...
        <span className="rounded-full border border-white/15 px-3 py-1 text-[11px] font-medium text-white/80">
          Schedule tour
        </span>
      </div>
    </article>
    ...
    <>
            ...
            <div className="relative grid lg:grid-cols-[1fr_1.05fr]">
              <div className="flex flex-col justify-center p-8 lg:p-12 xl:p-14">
                ...
                <p className="mt-6 max-w-lg text-sm leading-relaxed text-dark-text-secondary sm:text-base">
                  Orion Crest Estates is a luxury UI specimen — towers, villas, and podium
                  landscapes rendered through gradient compositions only. Use it as a benchmark for
                  how Bitcraftly articulates premium real-estate brands online.
                </p>
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {STATS.map((s) => (
              <div key={s.label} className="text-center md:text-left">
                <p className="font-[var(--font-playfair)] text-2xl font-semibold text-amber-100 sm:text-3xl">
                  {s.value}
                </p>
                <p className="mt-1 text-[11px] font-medium uppercase tracking-wide text-dark-text-tertiary">
                  {s.label}
                </p>
              </div>
            ))}
      ...
      <section className={`${CONTAINER} py-14 md:py-16`}>
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-amber-400/85">
            Signature promises
          </p>
          <h2 className="mt-3 font-[var(--font-playfair)] text-3xl text-dark-text-primary sm:text-4xl">
            Designed for legacy buyers
          </h2>
        </div>
        ...
        <div className={`${CONTAINER}`}>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="max-w-md text-sm text-dark-text-secondary">
              High-trust property cards with pricing bands & availability cues.
            </p>
          </div>
      ...
      <section id="ongoing" className={`${CONTAINER} scroll-mt-28 py-14 md:py-16`}>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {ONGOING.map((p) => (
            <div
              key={p.name}
              className={`overflow-hidden rounded-xl border border-dark-border-primary bg-gradient-to-br ${p.tone}`}
            >
              <div className="border-t border-slate-200/80 bg-white/85 p-5 backdrop-blur-sm">
                <p className="font-semibold text-white">{p.name}</p>
                <p className="mt-2 text-[11px] font-medium uppercase tracking-wide text-amber-200/90">
                  {p.eta}
                </p>
      ...
      <section
        id="villas"
        className="scroll-mt-28 border-y border-dark-border-primary bg-dark-bg-secondary/20 py-14 md:py-16"
      >
        <div className={`${CONTAINER}`}>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {VILLAS.map((v) => (
              <div
                key={v.type}
                className={`overflow-hidden rounded-2xl border border-dark-border-primary bg-gradient-to-br ring-1 ring-amber-500/10 ${v.tone}`}
              >
      ...
      <section id="apartments" className={`${CONTAINER} scroll-mt-28 py-14 md:py-16`}>
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {APARTMENTS.map((a) => (
            <div
              key={a.cfg}
              className={`rounded-2xl border border-dark-border-primary bg-gradient-to-br p-6 ${a.tone}`}
            >
      ...
      <section
        id="amenities"
        className="scroll-mt-28 border-y border-dark-border-primary bg-dark-bg-secondary/30 py-14 md:py-16"
      >
        <div className={`${CONTAINER}`}>
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-amber-400/85">
      ...
      <section id="floor-plans" className={`${CONTAINER} scroll-mt-28 py-14 md:py-16`}>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <p className="max-w-md text-sm text-dark-text-secondary">
            Blueprint silhouettes as luxury UI — vector grids instead of flat uploads.
          </p>
        </div>
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          {FLOOR_PLANS.map((fp) => (
            <div
              key={fp.name}
              className="rounded-2xl border border-dark-border-primary bg-dark-bg-card p-6"
            >
        ...
        <div className={`${CONTAINER}`}>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 font-[var(--font-playfair)] text-3xl text-dark-text-primary sm:text-4xl">
                Filter the skyline story
              </h2>
            </div>
            <p className="max-w-md text-sm text-dark-text-secondary">
              Tap filters — curated gradient tiles respond instantly.
            </p>
          </div>
          <div className="mt-10">
      ...
      <section id="booking" className={`${CONTAINER} scroll-mt-28 pb-14 md:pb-16`}>
        <div className="overflow-hidden rounded-2xl border border-amber-500/25 bg-gradient-to-r from-violet-50/80 via-[#140c18] to-amber-950/40 p-8 md:flex md:items-center md:justify-between md:gap-10 md:p-10">
          <div>
            ...
            <h2 className="mt-3 font-[var(--font-playfair)] text-2xl text-white md:text-3xl">
              Book a sunrise tour · chauffeured
            </h2>
            <p className="mt-3 max-w-xl text-sm leading-relaxed text-white/65">
              CRM-ready booking strip — slots, sales partner routing, and WhatsApp confirmation
              hooks ship on real builds.
            </p>
          </div>
          <div className="mt-6 flex shrink-0 flex-col gap-3 md:mt-0 md:items-end">
            ...
            <ShowcaseAnchor
              ...
              className="text-xs font-medium text-amber-100/90 hover:text-white"
            >
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-dark-text-secondary">
              A fictional master developer conceived for this UI showcase — representing how we
              choreograph luxury launches: phased renders, investor annexes, NRIs-ready PDF vaults,
              and bilingual microcopy tuned for trust.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-dark-text-secondary">
              Bitcraftly builds similar surfaces for real promoters — inventory APIs, floor-plan
              annotators, and mortgage partner rails optional.
            </p>
          </div>
          <div className="rounded-2xl border border-dark-border-primary bg-dark-bg-card p-8">
            <dl className="space-y-4 text-sm">
              ...
              <div className="flex justify-between gap-4 border-b border-dark-border-primary pb-4">
                ...
                <dd className="font-semibold text-dark-text-primary">
                  Metro bay · fictional HQ tower
                </dd>
              </div>
              <div className="flex justify-between gap-4 border-b border-dark-border-primary pb-4">
                <dt className="text-dark-text-tertiary">ISO cues</dt>
                <dd className="font-semibold text-dark-text-primary">
                  Design-system badges · demo only
                </dd>
              </div>
              <div className="flex justify-between gap-4">
                <dt className="text-dark-text-tertiary">CSR pillar</dt>
                <dd className="font-semibold text-dark-text-primary">
                  Scholarship corpus · urban forestry
                </dd>
              </div>
            </dl>
          </div>
      ...
      <section
        id="contact-enquiry"
        className="scroll-mt-28 border-t border-dark-border-primary bg-dark-bg-secondary/25 py-14 md:pb-20"
      >
        <div className={`${CONTAINER}`}>
          <div className="mx-auto max-w-3xl">
            <div className="text-center">
              ...
              <h2 className="mt-3 font-[var(--font-playfair)] text-3xl text-dark-text-primary sm:text-4xl">
                Brief our sales studio
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-sm text-dark-text-secondary">
                Structured enquiry capture — mirrors CRM-ready fields we deploy on production
                builds.
              </p>
            </div>
            ...
            <p className="mx-auto mt-8 max-w-2xl text-center text-[11px] leading-relaxed text-dark-text-tertiary">
              Entire experience is a fictional luxury developer UI specimen for Bitcraftly —
              pricing, projects, and timelines are illustrative only.
            </p>
          </div>
        </div>
      </section>
