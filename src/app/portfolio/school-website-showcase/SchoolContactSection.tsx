...
export default function SchoolContactSection() {
  ...
  return (
    <section
      id="contact"
      className="school-bg-surface scroll-mt-28 border-t school-border py-14 lg:py-16"
    >
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <button
                ...
                className="school-btn-navy rounded-md px-5 py-2.5 text-sm font-bold uppercase"
              >
                Book Campus Visit
              </button>
            </div>
