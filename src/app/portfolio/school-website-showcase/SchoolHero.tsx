...
export default function SchoolHero() {
  ...
  return (
    <section
      id="top"
      className="school-hero relative min-h-[520px] overflow-hidden bg-[var(--school-navy)] sm:min-h-[560px] lg:min-h-[580px]"
    >
        ...
        <div className="school-hero-body grid gap-8 py-10 sm:py-11 lg:grid-cols-[minmax(0,1fr)_minmax(280px,340px)] lg:items-start lg:gap-6 lg:py-12 xl:gap-8">
          ...
          >
            <div className="border-b school-border px-5 py-4 text-center">
              ...
              <p className="mt-0.5 text-lg font-bold leading-tight text-[var(--school-orange)]">
                Admissions Open
              </p>
            </div>
