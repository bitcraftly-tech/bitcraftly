      ...
      <section className="sc-home-hero" aria-labelledby="sc-home-hero-heading">
        <div className={`${CONTAINER} sc-home__section-pad`}>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 id="sc-home-hero-heading" className="sc-home__title mt-4 text-4xl sm:text-5xl lg:text-[3.2rem]">
              Reliable local services{' '}
              <span className="sc-home__title-mark">at your doorstep</span>
            </h1>
          ...
          <div className="sc-home-why">
            <div>
              ...
              <p className="sc-home__lead mt-4">
                Operators win when enquiry friction drops — these patterns mirror CRM, telephony, and
                WhatsApp Cloud API wiring on real deployments.
              </p>
            </div>
