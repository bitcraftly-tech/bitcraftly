  ...
  return (
    <>
      <button
        ...
        onClick={closeCart}
      />
      <aside className="toy-drawer" role="dialog" aria-modal="true" aria-labelledby="toy-cart-title">
        <div className="toy-drawer__head">
          <h2 id="toy-cart-title">Your cart</h2>
          <button type="button" className="toy-drawer__close" aria-label="Close cart" onClick={closeCart}>
