...
export default function GymFitnessShowcaseDemo() {
  const { city, setPassModal, setClassModal, setCenterModal, setReelOpen, scrollToSection } =
    useGymDemo();
  ...
  return (
    <div>
      ...
      <section
        id="formats"
        className="gym-formats gym-section scroll-mt-24"
        aria-labelledby="gym-formats-title"
      >
          ...
          <div className="gym-passes__grid">
            {MEMBERSHIP_PASSES.map((pass, i) => (
              <GymReveal
                ...
                delay={i * 0.08}
              >
                {pass.featured ? <span className="gym-pass-card__badge">Most popular</span> : null}
