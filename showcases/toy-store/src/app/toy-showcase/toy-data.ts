...
export type ToyCategory =
  'action' | 'blocks' | 'dolls' | 'educational' | 'rc' | 'arts' | 'baby' | 'outdoor' | 'games';
...
export const TOY_HERO_SLIDES: readonly ToyHeroSlide[] = [
  ...
  },
  {
    ...
    description:
      'Fresh picks just landed — building sets, soft toys, and creative kits for curious kids.',
  ...
  },
  {
    ...
    description:
      'From cuddly plush to STEM kits — thoughtful gifts that spark smiles and learning.',
  ...
  },
  {
    ...
    description:
      'RC cars, balance bikes, and outdoor fun — energy-packed toys for little adventurers.',
...
export const TOY_SIDEBAR_CATEGORIES: readonly {
  ...
  readonly icon:
    'bot' | 'blocks' | 'heart' | 'lightbulb' | 'car' | 'palette' | 'baby' | 'sun' | 'puzzle';
