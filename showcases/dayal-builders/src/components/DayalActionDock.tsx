...
import { Bot, Calendar, ChevronUp, MessageCircle, Phone } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <button
          type="button"
          onClick={onOpenChat}
          className={`${RAIL_BTN} relative bg-[#0b1633] text-[#d4b57d] hover:bg-[#152a52]`}
      ...
      >
        <div className="mx-auto grid max-w-lg grid-cols-4">
          ...
          <a href={waUrl} target="_blank" rel="noopener noreferrer" className="dayal-dock__item">
