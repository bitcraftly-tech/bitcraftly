...
export default function ShowcaseThemeToggle() {
  const { resolvedTheme, setTheme } = useShowcaseTheme();
  ...
  return (
    <div className="fixed bottom-5 right-5 z-40">
      <button
        ...
        className="group flex h-8 cursor-pointer items-center rounded-full border-0 bg-bg-card/90 p-1 shadow-[0_2px_16px_-4px_rgba(0,0,0,0.12)] backdrop-blur-md transition-[box-shadow,transform] duration-300 hover:shadow-[0_4px_20px_-6px_rgba(0,0,0,0.18)] active:scale-[0.98] dark:bg-dark-bg-card/90"
      >
        <span
        ...
        >
          <motion.span
            className="flex h-4 w-4 items-center justify-center rounded-full bg-white shadow-[0_1px_2px_rgba(0,0,0,0.1)]"
            initial={false}
