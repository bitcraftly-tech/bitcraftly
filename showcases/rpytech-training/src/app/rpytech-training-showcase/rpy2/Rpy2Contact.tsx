...
const CONTACT_INFO = [
  ...
  { Icon: Globe, label: 'Website', value: 'www.rpytech.in' },
  {
    ...
    label: 'Address',
    value:
      'Shyama Market, 1st Floor, Near Ghosh & Sinha Petrol Pump, Mirganj, Gopalganj, Bihar 841438',
  },
];
    ...
    <section className="rpyv2-contact" id="contact" aria-label="Contact us">
      <div className="rpyv2-container rpyv2-contact-grid">
        ...
        <div>
          ...
          <h2 className="rpyv2-contact-heading">We&apos;re Here to Help You</h2>
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="rpyv2-form-row">
                  <div className="rpyv2-form-group">
                    <label htmlFor="rpy2-name" className="rpyv2-sr-only">
                      Your Name
                    </label>
                    <input
                      id="rpy2-name"
                  ...
                  <div className="rpyv2-form-group">
                    <label htmlFor="rpy2-email" className="rpyv2-sr-only">
                      Your Email
                    </label>
                    <input
                      id="rpy2-email"
                ...
                <div className="rpyv2-form-group">
                  <label htmlFor="rpy2-phone" className="rpyv2-sr-only">
                    Phone Number
                  </label>
                  <input
                    id="rpy2-phone"
                ...
                <div className="rpyv2-form-group">
                  <label htmlFor="rpy2-message" className="rpyv2-sr-only">
                    Message
                  </label>
                  <textarea
                    id="rpy2-message"
