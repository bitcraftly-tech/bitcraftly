      ...
      <div className="rpyv2-container">
        ...
        <div className="rpyv2-aff-header">
          ...
          <div className="rpyv2-aff-header-text">
            <p className="rpyv2-section-label" style={{ textAlign: 'center' }}>
        ...
        <div className="rpyv2-aff-slider">
          {/* Prev arrow */}
          <button
            className="rpyv2-aff-arrow rpyv2-aff-arrow--l"
            onClick={() => go('left')}
            aria-label="Previous"
          >
            <ChevronLeft size={22} />
            ...
            {cards.map((idx, slot) => {
              ...
              return (
                ...
                >
                  ...
                  {isCtr && <div className="rpyv2-aff-badge">✓ Verified</div>}
                </div>
              );
            })}
          </div>
          ...
          {/* Next arrow */}
          <button
            className="rpyv2-aff-arrow rpyv2-aff-arrow--r"
            onClick={() => go('right')}
            aria-label="Next"
          >
        ...
        <div className="rpyv2-aff-dots" role="tablist">
          {AFFILIATES.map((_, i) => (
            <button
              ...
              onClick={() => {
                setAnimDir(i > center ? 'right' : 'left');
                setCenter(i);
              }}
