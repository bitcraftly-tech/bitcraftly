...
const STEPS = [
  {
    ...
    desc: 'Browse our wide catalogue and select the certification that aligns with your career goals.',
    accent: '#22c55e',
  },
  {
    num: '02',
    ...
    desc: 'Pick from a range of available dates and examination centers that suit you best.',
    accent: '#38bdf8',
  },
  {
    num: '03',
    ...
    desc: 'Fill in your personal details and securely complete the online registration form.',
    accent: '#a78bfa',
  },
  {
    num: '04',
    Icon: MapPin,
    title: 'Find Exam Center',
    desc: 'Use our locator to find the nearest test center offering your chosen exam.',
    accent: '#fb923c',
  },
  {
    num: '05',
    ...
    desc: 'Appear at your selected test center on time and give it your best shot.',
    accent: '#f472b6',
  },
  {
    num: '06',
    Icon: Gem,
    title: 'Get Certified',
    desc: 'Receive your verified certificate and step confidently into a brighter future.',
    accent: '#facc15',
  },
];
  ...
  return (
    <section className="rpyv2-hiw" id="how-it-works" aria-label="How it works">
      ...
      <div className="rpyv2-hiw-head">
        ...
        <p className="rpyv2-hiw-sub">
          Your journey from enrollment to certification — six simple steps.
        </p>
      </div>
        ...
        {STEPS.map(({ num, Icon, title, desc, accent }, i) => {
          ...
          return (
            <div key={num} className={`rpyv2-hiw-row rpyv2-hiw-row--${side}`}>
              ...
              {/* Node on spine */}
              <div
                className="rpyv2-hiw-node"
                style={{ '--hiw-accent': accent } as React.CSSProperties}
                aria-hidden
              >
                <span>{num}</span>
              </div>
