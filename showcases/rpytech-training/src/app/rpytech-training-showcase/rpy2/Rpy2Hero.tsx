      ...
      <div className="rpyv2-container rpyv2-hero-inner">
        ...
        <div className="rpyv2-hero-left">
          ...
          <h1 className="rpyv2-hero-heading">
            Empowering Skills.
            <br />
            Building <span className="rpyv2-hero-heading--orange">Careers.</span>
          </h1>

          <p className="rpyv2-hero-sub">
            Vocational Training, Fire &amp; Safety, NDT, QA/QC, Industrial Certifications and more.
            Industry-aligned programs for your bright future.
          </p>
