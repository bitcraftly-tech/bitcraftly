...
import { User, LogIn, CheckCircle, Phone, ChevronDown, X } from 'lucide-react';
import {
  FacebookIcon,
  TwitterIcon,
  InstagramIcon,
        ...
        <div className="rpyv2-container rpyv2-topbar-inner">
          ...
          <div className="rpyv2-topbar-right">
            ...
            <div className="rpyv2-topbar-highlights">
              <a
                href="#certifications"
                className="rpyv2-topbar-highlight rpyv2-topbar-highlight--cert"
              >
                🏆 Our Certificates
              </a>
            ...
            <nav className="rpyv2-topbar-links" aria-label="Quick links">
              ...
              <span className="rpyv2-topbar-sep" aria-hidden>
                |
              </span>
              <a href="#" className="rpyv2-topbar-link">
            ...
            <div className="rpyv2-topbar-social" aria-label="Social media">
              {[
                ...
                <a key={label} href="#" className="rpyv2-topbar-social-btn" aria-label={label}>
            ...
            {NAV_ITEMS.map((item) => (
              <li key={item.label} className="rpyv2-nav-item" role="none">
                ...
                >
                  {item.label}
                  {item.children && (
                    <ChevronDown size={12} className="rpyv2-nav-chevron" aria-hidden />
                  )}
                </a>
                {item.children && (
