...
const FEATURES = [
  {
    ...
    desc: 'Mentors with advanced credentials and classroom-tested pedagogy.',
    icon: Users,
  },
  {
    title: 'Smart Classes',
    desc: 'Interactive panels, curated LMS modules, and blended learning flows.',
    icon: MonitorPlay,
  },
  {
    title: 'Sports Activities',
    desc: 'Structured athletics, house leagues, and holistic fitness programs.',
    icon: Trophy,
  },
  {
    title: 'Secure Campus',
    desc: 'Controlled access, CCTV coverage, and student safety protocols.',
    icon: Shield,
  },
  {
    title: 'Transport Facility',
    desc: 'GPS-tracked routes with trained attendants across city zones.',
    icon: Bus,
  },
] as const;
...
const PROGRAMS = [
  {
    ...
    grades: 'Nursery – Grade V',
    tone: 'from-violet-600/40 to-indigo-950/80',
  },
  {
    name: 'Middle School',
    grades: 'Grade VI – VIII',
    tone: 'from-fuchsia-600/35 to-purple-950/80',
  },
  {
    name: 'Senior Secondary',
    grades: 'Grade IX – XII · CBSE',
    tone: 'from-indigo-500/35 to-slate-950/90',
  },
  {
    name: 'STEM & Innovation Lab',
    grades: 'Robotics · Coding · Science fairs',
    tone: 'from-emerald-600/30 to-violet-950/85',
  },
  {
    name: 'Arts & Performing Arts',
    grades: 'Music · Drama · Visual arts',
    tone: 'from-rose-500/35 to-violet-950/85',
  },
  {
    name: 'Leadership & Clubs',
    grades: 'Debates · MUN · Community projects',
    tone: 'from-amber-500/30 to-neutral-950/90',
  },
] as const;
...
const ACHIEVEMENTS = [
  {
    title: 'National Science Olympiad · Gold cohort',
    year: '2025',
    detail: '12 students in top 1% nationally.',
  },
  {
    title: 'CBSE merit honors · Grade XII',
    year: '2025',
    detail: '94% first division · 38 distinctions.',
  },
  {
    title: 'Asia-Pacific Robotics · Finalist',
    year: '2024',
    detail: 'Team Orion · autonomous rescue prototype.',
  },
] as const;
...
const ADMISSION_STEPS = [
  {
    ...
    body: 'Submit interest online or walk in — weekend tours available.',
  },
  {
    step: '02',
    title: 'Interaction & assessment',
    body: 'Age-appropriate readiness conversation; transparent rubrics.',
  },
  {
    step: '03',
    title: 'Offer & documentation',
    body: 'Seat confirmation with verified records and fee schedule.',
  },
  {
    step: '04',
    title: 'Orientation week',
    body: 'Buddy program, uniform kit, and LMS onboarding for families.',
  },
] as const;

const EVENTS = [
  {
    title: 'Annual Innovation Expo',
    date: 'March 14 · 2026',
    tag: 'STEM',
  ...
  {
    title: 'Parent–teacher symposium',
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-dark-border-primary">
        ...
        <div
          className={`${CONTAINER} relative grid gap-10 py-14 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center lg:gap-14 lg:py-20`}
        >
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-dark-text-secondary sm:text-lg">
              Smart education blends rigorous academics with digital-first classrooms — empowering
              learners with curiosity, collaboration, and character for a connected world.
            </p>
                ...
                <div className="flex h-full flex-col justify-between rounded-xl border border-slate-200/80 bg-white/70 p-5 backdrop-blur-sm sm:p-6">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 font-[var(--font-playfair)] text-xl font-semibold text-white">
                  ...
                  <p className="mt-6 text-[11px] leading-relaxed text-white/55">
                    Stylized classroom hero · fictional institution · no stock photography —
                    gradient composition only.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
            {STATS.map((s) => (
              <div key={s.label} className="text-center md:text-left">
                <p className="font-[var(--font-playfair)] text-3xl font-semibold text-dark-text-primary sm:text-4xl">
                  {s.value}
                </p>
                <p className="mt-1 text-xs font-medium uppercase tracking-wide text-dark-text-tertiary">
                  {s.label}
                </p>
              </div>
            ))}
      ...
      <section className={`${CONTAINER} py-14 md:py-16`}>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-sm leading-relaxed text-dark-text-secondary">
            Premium school portals balance credibility with warmth — these pillars mirror how we
            structure education sites for clients.
          </p>
        </div>
      ...
      <section className="border-y border-dark-border-primary bg-dark-bg-secondary/25 py-14 md:py-16">
        <div className={`${CONTAINER} grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16`}>
          <div>
            ...
            <h2 className="mt-3 font-[var(--font-playfair)] text-3xl text-dark-text-primary sm:text-4xl">
              Learning rooted in values
            </h2>
            <p className="mt-5 text-sm leading-relaxed text-dark-text-secondary">
              Green Valley Academy is a fictional showcase campus — representing how we design
              admissions storytelling, leadership bios, and outcome metrics for real schools.
              Narratives stay authentic; layouts stay crisp on mobile.
            </p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-dark-border-primary bg-dark-bg-card p-6">
              ...
              <p className="mt-4 font-[var(--font-playfair)] text-2xl font-semibold text-dark-text-primary">
                CBSE aligned
              </p>
              <p className="mt-2 text-xs text-dark-text-tertiary">
                Predictable progression · transparent grading rubrics.
              </p>
            </div>
            <div className="rounded-xl border border-dark-border-primary bg-dark-bg-card p-6 sm:mt-8">
              ...
              <p className="mt-2 text-xs text-dark-text-tertiary">
                Lexile-tracked programs · author immersions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={`${CONTAINER} py-14 md:py-16`}>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <p className="max-w-md text-sm text-dark-text-secondary">
            Dense grids like this scale cleanly with CSS Grid — mobile stacks first.
          </p>
        </div>
      ...
      <section className="border-y border-dark-border-primary bg-dark-bg-secondary/20 py-14 md:py-16">
        <div className={`${CONTAINER} grid gap-12 lg:grid-cols-2`}>
          <div>
            ...
            <h2 className="mt-2 font-[var(--font-playfair)] text-3xl text-dark-text-primary">
            ...
            <ul className="mt-8 space-y-3">
              {FACILITIES.map((line) => (
                <li
                  key={line}
                  className="flex items-start gap-3 rounded-lg border border-dark-border-primary bg-dark-bg-card px-4 py-3 text-sm text-dark-text-secondary"
                >
                  <span
                    className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-violet-400"
                    aria-hidden
                  />
                  {line}
                </li>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-dark-text-primary">
                    Interactive panels & capture
                  </p>
                  <p className="mt-1 text-xs leading-relaxed text-dark-text-secondary">
                    Lesson archives for revision · absentee catch-up playlists · parent visibility
                    toggles.
                  </p>
                </div>
              </div>
      ...
      <section className={`${CONTAINER} py-14 md:py-16`}>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {FACULTY.map((f) => (
            <div
              key={f.name}
              className="rounded-xl border border-dark-border-primary bg-dark-bg-card p-5 text-center"
            >
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {EVENTS.map((e) => (
            <div key={e.title} className={`rounded-xl border px-5 py-5 ${e.tone}`}>
              ...
              <p className="mt-3 font-[var(--font-playfair)] text-lg font-semibold text-dark-text-primary">
                {e.title}
              </p>
      ...
      <section className={`${CONTAINER} py-14 md:py-16`}>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <p className="max-w-md text-sm text-dark-text-secondary">
            Masonry-style rhythm without heavy assets — gradients + captions.
          </p>
        </div>
        ...
        <div className={`${CONTAINER}`}>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-4">
            {ADMISSION_STEPS.map((s) => (
              <div
                key={s.step}
                className="relative rounded-xl border border-dark-border-primary bg-dark-bg-card p-5"
              >
                <span className="font-[var(--font-playfair)] text-3xl font-semibold text-violet-400/80">
                  {s.step}
                </span>
      ...
      <section className={`${CONTAINER} py-14 md:pb-20`}>
        <div className="overflow-hidden rounded-2xl border border-dark-border-primary bg-dark-bg-card">
          <div className="grid lg:grid-cols-2">
            <div className="border-b border-dark-border-primary p-8 lg:border-b-0 lg:border-r lg:p-10">
              ...
              <p className="mt-4 text-sm leading-relaxed text-dark-text-secondary">
                Showcase contact strip — your live school site would wire maps, slots, and CRM
                handoffs here.
              </p>
            ...
            <div className="flex flex-col justify-center bg-gradient-to-br from-violet-50/60 via-[#120818] to-dark-bg-primary p-8 lg:p-10">
              ...
              <p className="mt-2 text-lg font-semibold text-dark-text-primary">
                Mon – Sat · 9:00 AM – 5:00 PM IST
              </p>
              <p className="mt-4 text-xs leading-relaxed text-dark-text-tertiary">
                Want this experience on your domain? Bitcraftly ships bespoke school & institute
                websites with admissions UX, multilingual content, and secure forms.
              </p>
              <ShowcaseLink
        ...
        <p className="mx-auto mt-8 max-w-2xl text-center text-[11px] leading-relaxed text-dark-text-tertiary">
          This page is a fictional education-portal UI specimen for Bitcraftly — not an operating
          school. Names, stats, and events are illustrative only.
        </p>
      </section>
    </>
  );
