    ...
    <section id="gallery" className="school-bg-surface scroll-mt-28 py-16">
      <div className={CONTAINER}>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="school-text-muted mt-3 text-sm">
            Moments from classrooms, sports, arts and celebrations.
          </p>
        </div>
          ...
          {GALLERY.map((g, i) => (
            ...
            >
              <SchoolLazyImage
                ...
                fallbackSeed={g.id}
              />
              <p className="truncate px-2 py-2 text-xs font-semibold text-[var(--school-navy)]">
                {g.title}
              </p>
            </button>
          ))}
