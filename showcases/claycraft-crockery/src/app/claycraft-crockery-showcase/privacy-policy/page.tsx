  ...
  return (
    <>
      ...
      <div className="cc-container cc-section cc-prose">
        <p>
          This Crockery Wala experience is a local demonstration. Form submissions and cart data
          stay in your browser session (local storage) and are not sent to a real backend.
        </p>
